...
# 
# Customized to my likings from these sources:
# - ThoughtBot  <http://giantrobots.thoughtbot.com/2008/12/23/script-console-tips>
# - Iain Hecker <http://github.com/iain/osx_settings/blob/master/.irbrc>
